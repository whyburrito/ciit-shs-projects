 ...
 * @author seans
 */
public class EditRegistrars extends javax.swing.JFrame {

    public int i, test = 0;
    /**
     * Creates new form EditRegistrars
     */
    public EditRegistrars() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("(Edit only when you have found a Registrar)");
        ...
        jLabel1.setText("Edit a Registrar");

        jLabel7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel7.setText("Month:");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel2.setText("Enter the First Name or the Last Name of the Registrar you want to edit:");
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        int y = -1;
        for (i = 0; i < Registrar.registrars.size(); i++) {

            String fName = Registrar.registrars.get(i).getFirstName();
        ...
        if (y == -1) {
            JOptionPane.showMessageDialog(this, "This Registrar does not exist", "Error", JOptionPane.ERROR_MESSAGE);
        }
            ...
            JOptionPane.showMessageDialog(frame, "Registrar Found! You may now edit their information");
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (firstName.isEmpty()){
            ...
            this.show(false);
            JOptionPane.showMessageDialog(this, "You did not search for a Registrar beforehand", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            ...
            Registrar.registrars.set(i, registrar);

            JFrame frame = new JFrame("Success!");
            JOptionPane.showMessageDialog(frame, "Registrar Information Successfully Modified!");
            this.show(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditRegistrars.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditRegistrars().setVisible(true);
            }
        });
    }
