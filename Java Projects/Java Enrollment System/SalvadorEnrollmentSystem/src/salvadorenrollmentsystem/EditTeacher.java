...
public class EditTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit a Teacher");
        ...
        jLabel2.setText("Enter the First Name or the Last Name of the Teacher you want to edit:");
        ...
        jLabel4.setText("(Edit only when you have found a Teacher)");
        ...
        subjectBox.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        subjectBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Programming", "Art", "Animation", "Science", "Math" }));
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    ...
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                            ...
                                                            .addComponent(subjectBox, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                            .addGroup(layout.createSequentialGroup()
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (firstName.isEmpty()){
            ...
            this.show(false);
            JOptionPane.showMessageDialog(this, "You did not search for a Teacher beforehand", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            ...
            int subjectIndex = subjectBox.getSelectedIndex();
            Subjects subject = Subjects.values()[subjectIndex];

            Teacher teacher = new Teacher(firstName, lastName, gender, birthDate, jobTitle, subject);
            Teacher.teachers.set(i, teacher);

            JFrame frame = new JFrame("Success!");
            JOptionPane.showMessageDialog(frame, "Teacher Information Successfully Modified!");
            this.show(false);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        int y = -1;
        for (i = 0; i < Teacher.teachers.size(); i++) {

            String fName = Teacher.teachers.get(i).getFirstName();
        ...
        if (y == -1) {
            ...
            JFrame frame = new JFrame("Success!");
            JOptionPane.showMessageDialog(frame, "Teacher Found! You may now edit their information");
